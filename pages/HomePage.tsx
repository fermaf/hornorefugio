    ...
    <div>
      ...
      <Section title="Una Experiencia Comunitaria" className="bg-stone-50">
        <div className="max-w-3xl mx-auto text-center text-xl text-stone-700 leading-relaxed">
            <p>
                Más que un simple alojamiento, El Galpón es el hogar de las almas mochileras, un punto de encuentro para viajeros de todo el mundo. Aquí se vive la aventura comunitaria, se comparten historias al calor de la cocina y se crean lazos que perduran.
            </p>
            <p className="mt-4">
