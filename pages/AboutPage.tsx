...
const AboutPage: React.FC = () => {
  return (
    <>
      <SEO
        title="Nuestro Espíritu | Refugio El Galpón"
        description="Conoce la historia y el corazón de Refugio El Galpón. Un espacio construido con amor y materiales reciclados."
      />
      <Section
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="prose prose-lg text-stone-700 max-w-none">
            <p>
              El <strong>HornoRefugio El Galpón</strong> nació en 2010 de la visión de <strong>Ricardo Licanqueo</strong>, quien soñó con un espacio para el arte, la cultura y la comunidad en el corazón de Hornopirén. Construido principalmente con <strong>materiales reciclados</strong> y una dedicación infinita, el refugio abrió sus puertas como <strong>hospedaje</strong> a los primeros viajeros en 2014.
            </p>
            <p>
