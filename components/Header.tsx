        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="-mr-2 flex lg:hidden">
            ...
            <button
              ...
              type="button"
              className="bg-emerald-800 inline-flex items-center justify-center p-2 rounded-md text-stone-300 hover:text-white hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-emerald-800 focus:ring-white"
