...
export const NAV_LINKS: NavLink[] = [
  { path: '/', label: 'nav.home' },
  { path: '/refugio', label: 'nav.about' },
  { path: '/alojamiento', label: 'nav.accommodation' },
  { path: '/arte', label: 'nav.art' },
  { path: '/voluntariado', label: 'nav.volunteer' },
  { path: '/contacto', label: 'nav.contact' },
];
...
export const COMMON_SPACES: CommonSpace[] = [
  { name: 'commonSpaces.kitchen.name', description: 'commonSpaces.kitchen.desc', icon: <KitchenIcon className="w-10 h-10 text-amber-600" /> },
  { name: 'commonSpaces.showers.name', description: 'commonSpaces.showers.desc', icon: <ShowerIcon className="w-10 h-10 text-amber-600" /> },
  { name: 'commonSpaces.bbq.name', description: 'commonSpaces.bbq.desc', icon: <BbqIcon className="w-10 h-10 text-amber-600" /> },
  { name: 'commonSpaces.library.name', description: 'commonSpaces.library.desc', icon: <LibraryIcon className="w-10 h-10 text-amber-600" /> },
  { name: 'commonSpaces.hammock.name', description: 'commonSpaces.hammock.desc', icon: <HammockIcon className="w-10 h-10 text-amber-600" /> },
];
